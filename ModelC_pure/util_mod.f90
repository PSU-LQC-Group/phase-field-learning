...
!----------------------------------------------------------------------------
!print 2D arrays signal1 & signal2 of dimension Nx by Ny into file numbered=file_no
...
!--------------------------------------------------
!converts integer "i" into character string, referenced as "cn(1:il)" in commands
...
!-----------------------------------------
!generates guassian deviates as above, may not work on some compilers
FUNCTION gasdev2() 
INTEGER idum 
REAL gasdev2
INTEGER iset 
